...
export default function SidebarHeader({
  ...
  return (
    <header className="flex shadow-md rounded-md h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 sticky top-0 bg-white">
