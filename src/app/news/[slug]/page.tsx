  ...
  return (
    <div className="px-6 md:px-12 pt-12 pb-6 flex flex-col md:flex-row">
      <div className="md:w-2/3">
        <h1>
          <Link href="/">Home</Link> &gt; <Link href="/news">Artikel</Link> &gt;{" "}
          <Link href={"/news/" + slug}>{post.title.rendered}</Link>
        </h1>
        <h1 className="text-navy font-semibold text-3xl md:text-5xl leading-12 md:leading-16">
          {post.title.rendered}
        </h1>
