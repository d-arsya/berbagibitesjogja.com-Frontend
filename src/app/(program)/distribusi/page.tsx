    ...
    <>
      <section className='bg-sky-100 -mx-2 md:-mx-32 py-6 text-center '>
        ...
        <div className='py-12 text-center px-3'>
          ...
          <p className='mt-8 font-medium text-slate-500 w-full md:w-3/4 m-auto leading-6 md:leading-8 text-sm md:text-lg'>Menjembatani makanan berlebih dengan mereka yang membutuhkan melalui sistem distribusi yang efisien dan berkelanjutan</p>
          <div className='bg-navy my-8 h-1 w-30 m-auto'></div>
        </div>
      </section>
      <section className='-mx-2 md:-mx-32 py-12 px-3 text-center'>
        ...
        <div className="flex w-max justify-center bg-teal-100 text-navy text-xs font-semibold px-6 py-2 gap-6 rounded-full m-auto mt-12">
          <div className="flex">
      ...
      <section className="py-12 px-6 -mx-2 md:-mx-32 md:px-32 bg-teal-50">
        <div className='py-12 text-center'>
          <h1 className='text-3xl md:text-4xl font-bold'>Dampak Program</h1>
          <p className='mt-8 font-medium text-slate-500 w-full md:w-3/4 m-auto leading-6 md:leading-8 text-sm md:text-lg'>Setiap kontribusi menciptakan perubahan nyata dalam komunitas kita</p>
          <div className='bg-navy my-8 h-1 w-30 m-auto'></div>
        </div>
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="bg-white shadow-md rounded-lg p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-slate-500">
                <li className='flex justify-between my-4'>Restoran: <span className="text-navy font-bold">42%</span></li>
                <li className='flex justify-between my-4'>Hotel: <span className="text-navy font-bold">35%</span></li>
                <li className='flex justify-between my-4'>Katering: <span className="text-navy font-bold">23%</span></li>
              </ul>
            </div>
            ...
            <div className="bg-white shadow-md rounded-lg p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-slate-500">
                <li className='flex justify-between my-4'>Panti Asuhan: <span className="text-navy font-bold">40%</span></li>
                <li className='flex justify-between my-4'>Lansia: <span className="text-navy font-bold">35%</span></li>
                <li className='flex justify-between my-4'>Komunitas Lain: <span className="text-navy font-bold">25%</span></li>
              </ul>
            </div>
            ...
            <div className="bg-white shadow-md rounded-lg p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-slate-500">
                <li className='flex justify-between my-4'>Pengurangan: <span className="text-navy font-bold">3.2 ton CO2</span></li>
                <li className='flex justify-between my-4'>Penghematan: <span className="text-navy font-bold">580,000 L air</span></li>
                <li className='flex justify-between my-4'>Penerima Manfaat: <span className="text-navy font-bold">4,200+</span></li>
              </ul>
            </div>
          </div>
        </div>
