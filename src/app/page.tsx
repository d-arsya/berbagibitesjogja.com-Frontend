  ...
  return (
    <>
      ...
      <section className='-mx-2 md:-mx-32 bg-slate-100 py-12 flex md:flex-row flex-col-reverse justify-between px-4 md:px-32'>
        <Image src='/mission-image.png' width='550' height='550' className='rounded-md mt-6 md:mt-0' alt='pembagian makanan' />
        <div className='w-full md:w-1/2'>
          ...
          <div className='flex flex-col gap-y-8 mt-12'>
            <div className='bg-white shadow-md p-4 rounded-md flex gap-x-4'>
