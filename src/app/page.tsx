...
import { Apple, CheckCircle, Clock, ForkKnife, GraduationCap, HandPlatter, Handshake, Heart, Instagram, Linkedin, Mail, MapPin, MapPinHouse, Music2, Phone } from 'lucide-react';
...
const ourPrograms = [
  {
    ...
    description: "Mengumpulkan kelebihan makanan berkualitas dari restoran, hotel, dan toko untuk mencegah pemborosan. Program ini telah menyelamatkan lebih dari 1470 kg makanan.",
    link: "/penyelamatan",
  ...
  },
  {
    ...
    description: "Menyalurkan makanan yang diselamatkan ke panti asuhan, lansia, dan komunitas yang membutuhkan. Telah membantu lebih dari 6940 penerima manfaat.",
    link: "/distribusi",
    flag: "High Impact",
    aos: 'fade-up'
  },
  ...
  return (
    <>
      ...
      <section className='py-12 text-center'>
        <h1 data-aos='fade-up' className='text-navy text-3xl md:text-4xl font-bold'>Dampak Usaha Kami</h1>
        ...
        <div>
          <div className='flex flex-col md:flex-row justify-between my-12 gap-y-12 md:gap-x-12 px-4 md:px-1'>
            <div data-aos='fade-right' className='bg-navy-light rounded-md flex w-full flex-col gap-y-4 py-12 md:py-18'  >
              ...
              <h2 className='font-bold text-navy text-4xl'><CountUp enableScrollSpy={true} end={1470} />+</h2>
            ...
            <div data-aos-offset='200' data-aos='fade-down' className='bg-navy-light rounded-md flex w-full flex-col gap-y-4 py-12 md:py-18'  >
              ...
              <h2 className='font-bold text-navy text-4xl'><CountUp enableScrollSpy={true} end={6940} />+</h2>
      ...
      <section className='-mx-2 md:-mx-32 py-12 px-6 text-center bg-slate-100'>
        <h1 className='text-navy text-3xl md:text-4xl font-bold'>Tentang Kami</h1>
        <div className='bg-navy my-8 h-1 w-30 m-auto'></div>
        <p className='font-medium md:font-semibold text-slate-500 w-full md:w-3/4 m-auto leading-6 md:leading-8 text-md md:text-lg'>Berbagi Bites Jogja adalah inisiatif nirlaba yang berfokus pada pengurangan limbah makanan melalui penyelamatan dan redistribusi makanan di seluruh Yogyakarta.</p>
      ...
      <section className='py-12 px-3'>
        ...
        <h2 className='text-navy font-bold text-3xl md:text-4xl text-center my-6'>Program Kami</h2>
      ...
      <section id='dampak' className='-mx-2 md:-mx-32 bg-navy-light px-3 py-12 md:px-32'>
            ...
            <div data-aos='fade' className='rounded-2xl bg-white w-full md:w-1/3 overflow-hidden'>
              ...
              <div className='p-6'>
                <div className='flex flex-col gap-y-2 pb-3'>
                  <p><CheckCircle className='w-4 mr-2 inline' />
                    Pengambilan makanan</p>
                  <p><CheckCircle className='w-4 mr-2 inline' />Distribusi ke komunitas</p>
                  <p><CheckCircle className='w-4 mr-2 inline' />Kampanye edukasi</p>
                  <p><CheckCircle className='w-4 mr-2 inline' />Administrasi</p>
            ...
            <div data-aos='fade-right' className='rounded-2xl bg-white w-full md:w-1/3 overflow-hidden'>
              ...
              <div className='p-6'>
                <div className='flex flex-col gap-y-2 pb-3'>
                  <p><CheckCircle className='w-4 mr-2 inline' />
                    Restoran</p>
                  <p><CheckCircle className='w-4 mr-2 inline' />Hotel</p>
                  <p><CheckCircle className='w-4 mr-2 inline' />Toko Makanan</p>
                  <p><CheckCircle className='w-4 mr-2 inline' />Pasar Tradisional</p>
